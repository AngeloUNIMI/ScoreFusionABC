function [dat100_2dat,VarName2] = importAllFile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [DAT100_2DAT,VARNAME2] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [DAT100_2DAT,VARNAME2] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [dat100_2dat,VarName2] = importfile('allFile_1.dat',1, 158603);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/05/13 16:10:52
